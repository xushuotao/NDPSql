...
set file ./clearA7.bit
set_property PROGRAM.FILE $file $artixfpga_0
puts "fpga is $artixfpga_0, bit file size is [exec ls -sh $file], CLEAR BEGIN"
program_hw_devices $artixfpga_0

set_property PROGRAM.FILE $file $artixfpga_1
puts "fpga is $artixfpga_1, bit file size is [exec ls -sh $file], CLEAR BEGIN"
program_hw_devices $artixfpga_1

set file ./clearVC707.bit
