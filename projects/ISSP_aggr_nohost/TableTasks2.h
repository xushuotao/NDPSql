...
#ifdef SIMULATION
uint64_t	totalRows = 8192*128/4;//1799989091/10000;
...
// InColParam  inColparam_extendedprice = InColParam{.colname="extendedprice", .filename=db_path+l_extendedprice, .param=inColInfo_extendedprice};                                                     InColParam  inColparam_discount      = InColParam{.colname="discount"     , .filename=db_path+l_discount     , .param=inColInfo_discount     };
